...
exp_config.pyramid_config.levels = [
    AbstractinatorConfig(
        ...
        c_num_compression_encoder_layers=2,
        c_num_queries=1,
        c_entropy_delta=0.2,
        c_output_length=512,
        c_vq_K=1024,
...
# Top transformer (embedding dim will be matched to top level D in train.py)
...
exp_config.sequence_length = 1024
